...
export const CurrentOfferCard = () => (
  <HomeCard variant="primary" className={styles.card}>
    <div className={styles.tittleBox}>
      <Typography variant="LabelL" className={styles.cardTittle}>
        Current Offer
      </Typography>
    ...
    <img
      ...
      alt="coffeePhoto"
    />
    <Typography variant="HeaderM" className={styles.textTittle}>
      Free Coffee
    </Typography>
    <Typography variant="ParagraphM" className={styles.cardText}>Earn up to a 32oz free coffee with a purchase of $20 in fuel.  Offer expires within 7 days of purchase.</Typography>
  </HomeCard>
)
