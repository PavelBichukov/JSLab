...
export const CodeEnterBlock = () => {
    ...
    return(
        <div className={styles.codeEnterBlock}>
            ...
            <Typography variant='ParagraphL'> Enter the 6-digit code that we sent to your email address {emailAddress} </Typography> 
            <form className={styles.codeForm}>
                <MuiOtpInput
                    ...
                    autoFocus
                />
                <button className={styles.codeEnterContinueButton} type='submit'> Continue </button>
            </form>
        </div>
    )
}
